...
\title{Three pills to kill classical physics:\\ why you should take them}
\author{Saúl Díaz Mansilla, CID 06070018}
\date{\small (Word count: 298 + 2327)}
...
Classical physics is \textit{ill}. Several diagnoses were made at the start of the 20th century, and the conclusion is clear: Newton's theory, successful throughout the 19th century, has a terminal illness. And I am here to convince you it has to die.

As a \st{physician} physicist, I will diagnose classcial physics to show you where does it fail, and what three pills that end its life and give rise to quantum mechanics. My hope is to convince you to take them: I will guide you through quantum's consequences, and show you what can it achieve as a theory.
...
\section{Diagnosis: the double slit experiment}
...
\section{Medication: quantum's birth}
...
\section{The consequences: tunneling}
...
\section{The reasons: quantum crystals and semiconductors}
