...
\title{A short guide to Quantum's hot tourist attractions: from wavefunctions to semiconductors}
...
\begin{abstract}
    ...
    Then it was just a matter of putting everything together (figures and equations) and writing. I revised the text a various times, checking with the rubric, to find poorly explained sections and to polish format and logic. I finally used AI to check for typos.
...
\begin{figure}[H]
    ...
    \caption{Conduction bands of a 1D crystal. The dotted red lines represent $-1$ and $1$. In blue the allowed energy bands, and in white the forbidden gaps.}
    \label{fig:bands}
\end{figure}
...
\begin{figure}[H]
     ...
     \end{subfigure}
     \caption{Conduction bands of various materials using the Kronig-Penney model. In blue the allowed energy bands, and in white the forbidden gaps.\cite{latticeconstants}\cite{bandsnote}}
